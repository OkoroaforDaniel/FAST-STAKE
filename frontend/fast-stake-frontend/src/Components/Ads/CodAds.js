  ...
  return (
    <div>
        <div className='GameAds'>
            ...
            <Link className='AdLink1' to="/CodAds">COD </Link> 
        ...
        <div>
            ...
            <div className='AdsDiv'>
                ...
                <div className='Stake'>
                    <p className='AdsStake'>Stake : COD 300 USD</p>
            ...
            <div className='AdsDiv'>
                ...
                <div className='Stake'>
                    <p className='AdsStake'>Stake : COD 150 USD</p>
                    <button className='StakeButton'>Stake</button>
                </div>
            </div>
            ...
            <div className='AdsDiv'>
                ...
                <div className='Stake'>
                    <p className='AdsStake'>Stake : COD 1000 USD</p>
                    <button className='StakeButton'>Stake</button>
                </div>
            </div>
