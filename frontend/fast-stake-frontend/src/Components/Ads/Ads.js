  ...
  return (
    <div>
        <div className='GameAds'>
            <p className='AdsGame'> 
            <Link className='AdLink1' to="/Ads" >PES  </Link>
        ...
        <div>
            <div className='AdsDiv'>
                ...
                <div className='Stake'>
                    <p className='AdsStake'>Stake : PES 10 USD</p>
                    <Link to='/OpenAds'>
            ...
            <div className='AdsDiv'>
                ...
                <div className='Stake'>
                    <p className='AdsStake'>Stake : PES 100 USD</p>
                    <button className='StakeButton'>Stake</button>
                </div>
            </div>
            ...
            <div className='AdsDiv'>
                ...
                <div className='Stake'>
                    <p className='AdsStake'>Stake : PES 50 USD</p>
                    <button className='StakeButton'>Stake</button>
                </div>
            </div>
            ...
            <div className='AdsDiv'>
                <div className='ImgStarMeduim'>
                    <div className='first-ads-div'>
                    <img className='online-user-Ads' src={Onlineuser4} alt='online-user1' />
                    </div>
                    <div className='AdsStar'>
                    <i class="fa-solid fa-certificate fa-xs" style={{ color: '#FFCD3C' }}></i>
                    <i class="fa-solid fa-certificate fa-xs" style={{ color: '#FFCD3C' }}></i>
                ...
                <div className='Stake'>
                    <p className='AdsStake'>Stake : PES 5 USD</p>
                    <button className='StakeButton'>Stake</button>
                </div>
            </div>
            ...
            <div className='AdsDiv'>
                <div className='ImgStarMeduim'>
                    <div className='first-ads-div'>
                    <img className='online-user-Ads' src={Onlineuser6} alt='online-user1' />
                    </div>
                    <div className='AdsStar'>
                    <i class="fa-solid fa-certificate fa-xs" style={{ color: '#FFCD3C' }}></i>
                    <i class="fa-solid fa-certificate fa-xs" style={{ color: '#FFCD3C' }}></i>
